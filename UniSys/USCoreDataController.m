...
@interface USCoreDataController ()
...
@implementation USCoreDataController
...
+ (id)sharedInstance {
    ...
    static USCoreDataController *sharedInstance;
    dispatch_once(&once, ^{
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"UniSys" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"UniSys.sqlite"];
